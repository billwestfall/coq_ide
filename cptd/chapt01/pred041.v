...
Coq < Goal forall (X : Type) (P Q: X->Prop), ( forall x : X, Q x \/ P x ) -> ( exists x : X, Px ).
Toplevel input, characters 87-89:
> Goal forall (X : Type) (P Q: X->Prop), ( forall x : X, Q x \/ P x ) -> ( exists x : X, Px ).
>                                                                                        ^^
Error: The reference Px was not found in the current environment.
